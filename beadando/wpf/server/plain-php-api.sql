...
INSERT INTO `users` (`id`, `email`,`name`, `password`, `token`,`admin`) VALUES
(1, 'rrd@webmania.cc', 'Lajos', '81dc9bdb52d04dc20036dbd8313ed055', '270fsdg04%rt2f6$)b4eblok0dfgaurannga','admin');
